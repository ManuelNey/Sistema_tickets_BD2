  ...
  return (
    <article className="reserva-card-new">
      <div className="reserva-card-head-new">
        <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at 30% 50%, rgba(124,58,237,0.1) 0%, transparent 60%)', pointerEvents: 'none' }} />
        ...
        <div>
          <div className="reserva-card-info-new">
            <div className="reserva-info-row-new">
              <TrxUserSvg />
              <span>Enviado a <strong style={{ color: '#130F1E' }}>{transferencia.receptor || '-'}</strong></span>
            </div>
            <div className="reserva-info-row-new">
              <TrxCalSvg />
